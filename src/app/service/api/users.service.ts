...
export class UsersService {
  url = "https://tapp.scd.edu.om/api/v1/users";
  ...
  public async createUser(data):Promise<any>{
    return new Promise( (resolve,reject) => {
      this.http.sendRequest( "https://tapp.scd.edu.om/api/v1/users" , {
        method: 'post',
  ...
  public async siginUser(data):Promise<any>{
    return new Promise( (resolve,reject) => {
      this.http.sendRequest( "https://tapp.scd.edu.om/api/v1/users/login" , {
        method: 'post',
        headers: {'content-type' : 'application/json','Authorization' : 'Bearer '+this.apiKey},
        data: data,
        serializer: 'json',
  ...
  public async sendVerification(data):Promise<any>{
    return new Promise( (resolve,reject) => {
      this.http.sendRequest("https://tapp.scd.edu.om/api/v1/users/resend" , {
        method: 'post',
        headers: {'content-type' : 'application/json','Authorization' : 'Bearer '+this.apiKey},
        data: data,
        serializer: 'json',
